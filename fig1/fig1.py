...
comtodraw=alphab[:15]
com2type={'A':'Other','B':'International sci-health','C':'Political',
         'D':'National elite','E':'Other','F':'Political',
          'G':'International sci-health','H':'Political','I':'National elite',
...
type2col = {'International sci-health': palette[4], 'National elite': palette[1], 'Political': palette[2], 'Other': '.5'} 
...
plt.savefig('plots/fig1/fig1.png', bbox_inches='tight',facecolor=f.get_facecolor())
